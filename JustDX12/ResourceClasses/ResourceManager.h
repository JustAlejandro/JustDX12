...
public:
	...
	DX12Resource* makeResource(std::string name, DESCRIPTOR_TYPES types = DESCRIPTOR_TYPE_SRV, DXGI_FORMAT format = HELPER_TEXTURE_FORMAT, UINT texHeight = SCREEN_HEIGHT, UINT texWidth = SCREEN_WIDTH);
private:
